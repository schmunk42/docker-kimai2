...
FROM php:8.1.0beta3-fpm-alpine3.13 AS fpm-php-ext-base
...
FROM php:8.1.0beta3-fpm-alpine3.13 AS apache-php-ext-base
RUN apt-get update
...
# fpm base build
FROM php:8.1.0beta3-fpm-alpine3.13 AS fpm-base
RUN apk add --no-cache \
        bash \
        coreutils \
        freetype \
...
FROM php:8.1.0beta3-fpm-alpine3.13 AS apache-base
